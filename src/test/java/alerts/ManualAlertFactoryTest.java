...
public class ManualAlertFactoryTest {
    ...
    @Test
    public void testCreateManualAlert() {

        AlertFactory factory = new ManualAlertFactory();
        ...
        assertTrue(generatedAlert instanceof ManualAlert, "The generated alert should be an instance of ManualAlert.");
